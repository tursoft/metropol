...
export class BoardComponent {
  data: BoardModel = {
    tiles: { 
      bottom: [
        { id: 1, title: 'Start', type: 'start', icon: 'start.png' },
      ...
      left: [
        ...
        { id: 16, title: 'Mersin Limanı', type: 'corp', price: 20000, icon: 'harbour.png' },
        ...
        { id: 21, title: 'Serbest Bölge', type: 'free-area', icon: 'passport.png' },
      ],
      ...
      top: [
        ...
        { id: 26, title: 'Samsun Limanı', type: 'corp', price: 20000, icon: 'harbour.png' },
        ...
        { id: 29, title: 'Türk Hava Yolları', type: 'corp', price: 20000, icon: 'plane.png' },
      ...
      right: [
        ...
        { id: 36, title: 'TCDD', type: 'corp', price: 20000, icon: 'tcdd.png' },
